...
<div class="container">
  <div class="row">
    ...
    <form action="/project/<c:out value="${projectItem.id}"/>/edit" method="POST">
  ...
  <button class="btn btn-xs btn-primary" onclick="window.location.href='/category/<c:out value="${categoryId.id}"/>'">
