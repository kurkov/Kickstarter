...
public class ReadBlogPostController implements Controller {

  private final ProjectService projectService;
  private final BlogPostService blogPostService;
  private final CommentService commentService;

  public ReadBlogPostController(ProjectService projectService, BlogPostService blogPostService, CommentService
          commentService) {
